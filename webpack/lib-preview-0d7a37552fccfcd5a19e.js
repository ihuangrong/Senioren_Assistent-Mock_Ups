...
break
default:N=R+N,r===_e&&(O+=N,N="")}else N=""
break
default:N=Ve(t,Ye(t,R,x),N,r,a+1)}I+=N,b=x=E=w=C=y=0,N=R="",p=n.charCodeAt(++S)
break
case Y:case V:if(R=(0<E?R.replace(j,""):R).trim(),1<(_=R.length))switch(0===w&&((d=R.charCodeAt(0))===ae||96<d&&d<123)&&(_=(R=R.replace(" ",":")).length),0<je&&void 0!==(i=Ge(De,R,t,e,Te,ke,O.length,r,a,r))&&0===(_=(R=i.trim()).length)&&(R="\0\0"),d=R.charCodeAt(0),f=R.charCodeAt(1),d){case he:break
case te:if(f===Ee||f===Ce){A+=R+n.charAt(S)
break}default:if(R.charCodeAt(_-1)===ce)break
O+=Ze(R,d,f,R.charCodeAt(2))}x=E=w=C=y=0,R="",p=n.charCodeAt(++S)}}switch(p){case $:case Q:if(u+s+l+c+Ie===0)switch(v){case X:case ue:case le:case te:case pe:case de:case oe:case fe:case se:case ae:case ce:case ie:case V:case Z:case Y:break
default:0<w&&(C=1)}u===se?u=0:Re+y===0&&r!==ge&&0<R.length&&(E=1,R+="\0"),0<je*Ue&&Ge(Le,R,t,e,Te,ke,O.length,r,a,r),ke=1,Te++
break
...
case oe:p===se&&h===oe&&_+2!==S&&(33===n.charCodeAt(_+2)&&(O+=n.substring(_,S+1)),M="",u=0)}}if(0===u){if(Re+s+c+b===0&&r!==ge&&p!==V)switch(p){case ie:case pe:case de:case fe:case X:case J:if(0===y){switch(h){case ee:case ne:case Q:case $:M+="\0"
break
...
default:0===y&&(E=1,M+="\0")}}R+=M,p!==ne&&p!==ee&&(v=p)}}m=h,h=p,S++}if(_=O.length,0<Ae&&0===_&&0===I.length&&0===t[0].length==0&&(r!==ye||1===t.length&&(0<Re?He:ze)===t[0])&&(_=t.join(",").length+2),0<_){if(o=0===Re&&r!==ge?function(e){for(var t,n,r=0,a=e.length,o=Array(a);r<a;++r){for(var i=e[r].split(L),c="",u=0,l=0,s=0,d=0,f=i.length;u<f;++u)if(!(0===(l=(n=i[u]).length)&&1<f)){if(s=c.charCodeAt(c.length-1),d=n.charCodeAt(0),t="",0!==u)switch(s){case oe:case pe:case de:case fe:case ne:case J:break
default:t=" "}switch(d){case re:n=t+He
case pe:case de:case fe:case ne:case X:case J:break
case G:n=t+n+He
break
case ce:switch(2*n.charCodeAt(1)+3*n.charCodeAt(2)){case 530:if(0<Oe){n=t+n.substring(8,l-1)
break}default:(u<1||i[u-1].length<1)&&(n=t+He+n)}break
case ie:t=""
default:n=1<l&&0<n.indexOf(":")?t+n.replace(U,"$1"+He+"$2"):t+n+He}c+=n}o[r]=c.replace(j,"").trim()}return o}(t):t,0<je&&void 0!==(i=Ge(Be,O,o,e,Te,ke,_,r,a,r))&&0===(O=i).length)return A+O+I
if(O=o.join(",")+"{"+O+"}",Ne*Me!=0){switch(2!==Ne||Je(O,2)||(Me=0),Me){case Se:O=O.replace(F,":"+H+"$1")+O
break
case we:O=O.replace(B,"::"+W+"input-$1")+O.replace(B,"::"+H+"$1")+O.replace(B,":"+z+"input-$1")+O}Me=0}}return A+O+I}function Ye(e,t,n){var r=t.trim().split(p),a=r,o=r.length,i=e.length
...
case ce:switch(a.charCodeAt(1)){case 103:if(0<Oe&&0<Re)return a.replace(h,"$1").replace(i,"$1"+ze)
break
...
return n!==t+";"?n.replace(r," or ($1)").substring(4):"("+t+")"}function Ge(e,t,n,r,a,o,i,c,u,l){for(var s,d=0,f=t;d<je;++d)switch(s=k[d].call(O,e,f,n,r,a,o,i,c,u,l)){case void 0:case!1:case!0:case null:break
...
case"compress":_=0|n
break
case"semicolon":Ie=0|n
break
case"preserve":Ae=0|n
break
case"prefix":T=null,n?"function"!=typeof n?Ne=1:(Ne=2,T=n):Ne=0}}return a}function O(e,t){if(void 0!==this&&this.constructor===O)return c(e)
...
var i=Ve(Pe,o,t,0,0)
return 0<je&&void 0!==(a=Ge(M,i,o,o,Te,ke,i.length,0,0,0))&&"string"!=typeof(i=a)&&(r=0),He=ze=We="",ke=Te=1,_*r==(Me=0)?i:i.replace(j,"").replace(v,"").replace(g,"$1").replace(y,"$1").replace(b," ")}return O.use=function e(t){switch(t){case void 0:case null:je=k.length=0
break
default:switch(t.constructor){case Array:for(var n=0,r=t.length;n<r;++n)e(t[n])
break
case Function:k[je++]=t
break
case Boolean:Ue=0|!!t}}return e},O.set=a,void 0!==e&&a(e),O}(null)},"2qqa":function(e,t,n){"use strict"
var r=n("TqRt")
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var N=a(n("J4zp")),o=a(n("lwsE")),i=a(n("W8MJ")),u=a(n("a1gu")),l=a(n("Nsbk")),c=a(n("7W2i")),s=a(n("PJYZ")),d=a(n("lSNA")),f=a(n("17x9")),O=r(n("q1tI")),I=a(n("M8nv")),A=a(n("foKU")),P=a(n("tBsX")),j=n("oose"),L=a(n("dYO+")),D=a(n("DdUa")),B=a(n("kJQk")),F=a(n("9ZUU")),U=a(n("TSYQ"))
n("fSKh")
...
return O.default.createElement(A.default,{x:h,y:m,scale:t,id:"simulator-container",className:R,onMouseDown:this.handleMouseDown,onScaleChange:this.handleScaleChange,onOffsetChange:this.handleOffsetChange},function(e,t,n){return O.default.createElement("div",{key:"1",className:(0,U.default)("screen-viewport",{"is-fullscreen":p,"is-geely":"geely_center_control"===a.model}),style:_},O.default.createElement("div",{className:"zoom-area",style:k},O.default.createElement(D.default,null),
!g&&O.default.createElement(L.default,{project:a,shellType:y,isLandscape:v}),c&&O.default.createElement(F.default,null)),O.default.createElement("div",{className:"no-zoom-area-wrapper",style:T},O.default.createElement("div",{className:"no-zoom-area",style:M},O.default.createElement("div",{id:"ui-layers",className:"ui-layers ".concat(s?"is-active":"")},f&&O.default.createElement(B.default,null),s&&!f&&O.default.createElement(P.default,null)),O.default.createElement("div",{id:"ui-comment-marker-panel"},
...
var n="[...effects]",O=Object(H.n)(W,Object(H.z)(n,"all("+n+")")),I=l.sagaMonitor,o=l.logger,i=l.onError,c=o||H.s,A=function(e){var t=e.sagaStack
...
try{i.cancel()}catch(e){A(e)}i.cancel=H.u,I&&I.effectCancelled(a)}}
var c,u,l,s,d,f,p,h,m,v,g,y,b,w,S,E,C,x,_,k=void 0
return H.q.promise(e)?F(e,i):H.q.helper(e)?q(Q(e),a,i):H.q.iterator(e)?U(e,a,N,i):H.q.array(e)?O(e,a,i):(k=Y.d.take(e))?function(e,t){var n=e.channel,r=e.pattern,a=e.maybe
n=n||P
...
if((t-=4)<0)break
o.push(n>>18|240,n>>12&63|128,n>>6&63|128,63&n|128)}}return o}function P(e){return c.toByteArray(function(e){if((e=(t=e,t.trim?t.trim():t.replace(/^\s+|\s+$/g,"")).replace(I,"")).length<2)return""
...
n.d(t,"m",function(){return _}),n.d(t,"j",function(){return k}),n.d(t,"y",function(){return M}),n.d(t,"t",function(){return O}),n.d(t,"s",function(){return I}),n.d(t,"n",function(){return A}),n.d(t,"z",function(){return P}),n.d(t,"p",function(){return j}),n.d(t,"k",function(){return L}),n.d(t,"A",function(){return D}),n.d(t,"i",function(){return B})
var r=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
...
return i=0===c.length?[E({},u.child,{text:""})]:c.map(function(e){return E({text:e.innerText.replace(/(\r\n|\n|\r)/gm,""),boldType:Number(e.dataset.boldtype)?1:0},_(e.style,u.child,Number(e.dataset.boldtype)))}),{paraSpacing:(r=t,a=n,o=r===a.length-1&&1<a.length?r-1:r,Number(a[o].style.marginBottom.replace("px",""))),children:i}})},N=[["&","&amp;"],["<","&lt;"],[">","&gt;"]],O=[].concat(N).reverse(),I=function(e){var a=e
...
E=m.children[b],C=E.text.slice(w?u:0,S?f:E.text.length),x=I(C)
...
t({type:"entry:preview:select",payload:{toolbarActiveItem:x.PREVIEW_CONFIG[e]}}),MB.event("".concat(x.TOOLBAR_TRAKING_CONFIG[n]),"运行页")}),e.dispatch({type:"reducer:preview-toolbar:active-item:init"}),O()&&r.props.dispatch({type:"entry:preview:select",payload:{toolbarActiveItem:x.INSPECT}}),r}return(0,d.default)(t,e),(0,c.default)(t,[{key:"UNSAFE_componentWillReceiveProps",value:function(e){var t=e.toolbarActiveItem,n=e.loadSliceUrl
...
"react.provider"):60109,l=r?Symbol.for("react.context"):60110,s=r?Symbol.for("react.concurrent_mode"):60111,d=r?Symbol.for("react.forward_ref"):60112,f=r?Symbol.for("react.suspense"):60113,p=r?Symbol.for("react.memo"):60115,h=r?Symbol.for("react.lazy"):60116
function m(e){if(null==e)return null
if("function"==typeof e)return e.displayName||e.name||null
if("string"==typeof e)return e
switch(e){case s:return"ConcurrentMode"
case o:return"Fragment"
case a:return"Portal"
case c:return"Profiler"
case i:return"StrictMode"
case f:return"Suspense"}if("object"==typeof e)switch(e.$$typeof){case l:return"Context.Consumer"
case u:return"Context.Provider"
case d:var t=e.render
return t=t.displayName||t.name||"",e.displayName||(""!==t?"ForwardRef("+t+")":"ForwardRef")
case p:return m(e.type)
case h:if(e=1===e._status?e._result:null)return m(e)}return null}var v=b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,g=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,S=Object.prototype.hasOwnProperty,
E={},C={}
function x(e){return!!S.call(C,e)||!S.call(E,e)&&(g.test(e)?C[e]=!0:!(E[e]=!0))}function _(e,t,n,r){if(null==t||function(e,t,n,r){if(null!==n&&0===n.type)return!1
...
case 6:return isNaN(t)||t<1}return!1}function k(e,t,n,r,a){this.acceptsBooleans=2===t||3===t||4===t,this.attributeName=r,this.attributeNamespace=a,this.mustUseProperty=n,this.propertyName=e,this.type=t}var T={}
"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){T[e]=new k(e,0,!1,e,null)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var t=e[0]
T[t]=new k(t,1,!1,e[1],null)}),["contentEditable","draggable","spellCheck","value"].forEach(function(e){T[e]=new k(e,2,!1,e.toLowerCase(),null)}),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){T[e]=new k(e,2,!1,e,null)}),"allowFullScreen async autoFocus autoPlay controls default defer disabled formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){T[e]=new k(e,3,!1,
e.toLowerCase(),null)}),["checked","multiple","muted","selected"].forEach(function(e){T[e]=new k(e,3,!0,e,null)}),["capture","download"].forEach(function(e){T[e]=new k(e,4,!1,e,null)}),["cols","rows","size","span"].forEach(function(e){T[e]=new k(e,6,!1,e,null)}),["rowSpan","start"].forEach(function(e){T[e]=new k(e,5,!1,e.toLowerCase(),null)})
var M=/[\-:]([a-z])/g
function R(e){return e[1].toUpperCase()}
...
" ").forEach(function(e){var t=e.replace(M,R)
T[t]=new k(t,1,!1,e,null)}),"xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var t=e.replace(M,R)
T[t]=new k(t,1,!1,e,"http://www.w3.org/1999/xlink")}),["xml:base","xml:lang","xml:space"].forEach(function(e){var t=e.replace(M,R)
T[t]=new k(t,1,!1,e,"http://www.w3.org/XML/1998/namespace")}),T.tabIndex=new k("tabIndex",1,!1,"tabindex",null)
var N=/["'&<>]/
...
case 62:t="&gt;"
break
default:continue}a!==n&&(r+=e.substring(a,n)),a=n+1,r+=t}e=a!==n?r+e.substring(a,n):r}return e}var I="http://www.w3.org/1999/xhtml"
function A(e){switch(e){case"svg":return"http://www.w3.org/2000/svg"
case"math":return"http://www.w3.org/1998/Math/MathML"
default:return"http://www.w3.org/1999/xhtml"}}var P={area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0},j=y({menuitem:!0},P),L={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,
gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},D=["Webkit","ms","Moz","O"]
Object.keys(L).forEach(function(t){D.forEach(function(e){e=e+t.charAt(0).toUpperCase()+t.substring(1),L[e]=L[t]})})
var B=/([A-Z])/g,F=/^ms-/,U=b.Children.toArray,q=v.ReactCurrentOwner,W={readContext:function(e){return e._currentValue}},H={listing:!0,pre:!0,textarea:!0},z=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,V={},Y={}
var Z={}
var J=Object.prototype.hasOwnProperty,X={children:null,dangerouslySetInnerHTML:null,suppressContentEditableWarning:null,suppressHydrationWarning:null}
function G(e,t){void 0===e&&w("152",m(t)||"Component")}function K(f,p){function e(e,t){var n=function(e,t){var n=e.contextType
if("object"==typeof n&&null!==n)return n._currentValue
if(e=e.contextTypes){for(var r in n={},e)n[r]=t[r]
t=n}else t=Z
...
null!=c&&(i.state=y({},i.state,c))}}else if(null==(i=t(e.props,n,o))||null==i.render)return void G(f=i,t)
...
if(G(f=i.render(),t),e=void 0,"function"==typeof i.getChildContext&&"object"==typeof(n=t.childContextTypes))for(var d in e=i.getChildContext())d in n||w("108",m(t)||"Unknown",d)
e&&(p=y({},p,e))}for(;b.isValidElement(f);){var t=f,n=t.type
if("function"!=typeof n)break
e(t,n)}return{child:f,context:p}}var Q=function(){function n(e,t){if(!(this instanceof n))throw new TypeError("Cannot call a class as a function")
e=b.isValidElement(e)?e.type!==o?[e]:(e=e.props.children,b.isValidElement(e)?[e]:U(e)):U(e),this.stack=[{type:null,domNamespace:I,children:e,childIndex:0,context:Z,footer:""}],this.exhausted=!1,this.currentSelectValue=null,this.previousWasTextNode=!1,this.makeStaticMarkup=t,this.contextIndex=-1,this.contextStack=[],this.contextValueStack=[]}return n.prototype.pushProvider=function(e){var t=++this.contextIndex,n=e.type._context,r=n._currentValue
...
q.currentDispatcher=W
try{for(var t="";t.length<e;){if(0===this.stack.length){this.exhausted=!0
break}var n=this.stack[this.stack.length-1]
if(n.childIndex>=n.children.length){var r=n.footer
t+=r,""!==r&&(this.previousWasTextNode=!1),this.stack.pop(),"select"===n.type?this.currentSelectValue=null:null!=n.type&&null!=n.type.type&&n.type.type.$$typeof===u&&this.popProvider(n.type)}else{var a=n.children[n.childIndex++]
t+=this.render(a,n.context,n.domNamespace)}}return t}finally{q.currentDispatcher=null}},n.prototype.render=function(e,t,n){if("string"==typeof e||"number"==typeof e)return""===(n=""+e)?"":this.makeStaticMarkup?O(n):this.previousWasTextNode?"\x3c!-- --\x3e"+O(n):(this.previousWasTextNode=!0,O(n))
if(e=(t=K(e,t)).child,t=t.context,null===e||!1===e)return""
if(!b.isValidElement(e)){if(null!=e&&null!=e.$$typeof){var r=e.$$typeof
r===a&&w("257"),w("258",r.toString())}return e=U(e),this.stack.push({type:null,domNamespace:n,children:e,childIndex:0,context:t,footer:""}),""}if("string"==typeof(r=e.type))return this.renderDOM(e,t,n)
switch(r){case i:case s:case c:case o:return e=U(e.props.children),this.stack.push({type:null,domNamespace:n,children:e,childIndex:0,context:t,footer:""}),""
case f:w("294")}if("object"==typeof r&&null!==r)switch(r.$$typeof){case d:return e=U(r.render(e.props,e.ref)),this.stack.push({type:null,domNamespace:n,children:e,childIndex:0,context:t,footer:""}),""
case p:return e=[b.createElement(r.type,y({ref:e.ref},e.props))],this.stack.push({type:null,domNamespace:n,children:e,childIndex:0,context:t,footer:""}),""
case u:return n={type:e,domNamespace:n,children:r=U(e.props.children),childIndex:0,context:t,footer:""},this.pushProvider(e),this.stack.push(n),""
case l:return r=U(e.props.children(e.type._currentValue)),this.stack.push({type:e,domNamespace:n,children:r,childIndex:0,context:t,footer:""}),""
case h:w("295")}w("130",null==r?r:typeof r,"")},n.prototype.renderDOM=function(e,t,n){var r=e.type.toLowerCase()
n===I&&A(r),V.hasOwnProperty(r)||(z.test(r)||w("65",r),V[r]=!0)
var a=e.props
...
break}}else o=""+i===u
a=y({selected:void 0,children:void 0},a,{selected:o,children:c})}}for(g in(o=a)&&(j[r]&&(null!=o.children||null!=o.dangerouslySetInnerHTML)&&w("137",r,""),null!=o.dangerouslySetInnerHTML&&(null!=o.children&&w("60"),"object"==typeof o.dangerouslySetInnerHTML&&"__html"in o.dangerouslySetInnerHTML||w("61")),null!=o.style&&"object"!=typeof o.style&&w("62","")),o=a,i=this.makeStaticMarkup,c=1===this.stack.length,u="<"+e.type,o)if(J.call(o,g)){var s=o[g]
if(null!=s){if("style"===g){l=void 0
var d="",f=""
for(l in s)if(s.hasOwnProperty(l)){var p=0===l.indexOf("--"),h=s[l]
if(null!=h){var m=l
if(Y.hasOwnProperty(m))m=Y[m]
else{var v=m.replace(B,"-$1").toLowerCase().replace(F,"-ms-")
m=Y[m]=v}d+=f+m+":",f=l,d+=p=null==h||"boolean"==typeof h||""===h?"":p||"number"!=typeof h||0===h||L.hasOwnProperty(f)&&L[f]?(""+h).trim():h+"px",f=";"}}s=d||null}l=null
...
break e
default:p=!0}p?X.hasOwnProperty(g)||(l=x(l=g)&&null!=s?l+'="'+O(s)+'"':""):(p=g,l=s,s=T.hasOwnProperty(p)?T[p]:null,(h="style"!==p)&&(h=null!==s?0===s.type:2<p.length&&("o"===p[0]||"O"===p[0])&&("n"===p[1]||"N"===p[1])),l=h||_(p,l,s,!1)?"":null!==s?(p=s.attributeName,3===(s=s.type)||4===s&&!0===l?p+'=""':p+'="'+O(l)+'"'):x(p)?p+'="'+O(l)+'"':""),l&&(u+=" "+l)}}i||c&&(u+=' data-reactroot=""')
var g=u
o="",P.hasOwnProperty(r)?g+="/>":(g+=">",o="</"+e.type+">")
e:{if(null!=(i=a.dangerouslySetInnerHTML)){if(null!=i.__html){i=i.__html
break e}}else if("string"==typeof(i=a.children)||"number"==typeof i){i=O(i)
break e}i=null}return null!=i?(a=[],H[r]&&"\n"===i.charAt(0)&&(g+="\n"),g+=i):a=U(a.children),e=e.type,n=null==n||"http://www.w3.org/1999/xhtml"===n?A(e):"http://www.w3.org/2000/svg"===n&&"foreignObject"===e?"http://www.w3.org/1999/xhtml":n,this.stack.push({domNamespace:n,type:r,children:a,childIndex:0,context:t,footer:o}),this.previousWasTextNode=!1,g},n}(),$={renderToString:function(e){return new Q(e,!1).read(1/0)},renderToStaticMarkup:function(e){return new Q(e,!0).read(1/0)},renderToNodeStream:function(
){w("207")},renderToStaticNodeStream:function(){w("208")},version:"16.6.0"},ee=$
e.exports=ee.default||ee},IOzZ:function(e,t){e.exports=function(t,n){return function(e){return null!=e&&e[t]===n&&(void 0!==n||t in Object(e))}}},IT1M:function(e,t,n){"use strict"
...
canDel:!0}),m.default.createElement(_,{title:I18N.preview_panel.screen_color,handleDelColor:this.handleDelColor,colorBlockMap:a,colorUnit:p}),m.default.createElement(_,{title:I18N.preview_panel.sketch_color,handleDelColor:this.handleDelColor,colorBlockMap:h,colorUnit:p,fromSketch:!0})),0<u.length&&m.default.createElement(g.WrapComponent,null,I18N.preview_panel.font_title,m.default.createElement(x,{globalText:u})))}}]),o}(m.PureComponent);(t.GlobalAttributes=C).propTypes={
...
var _=function(e){var a=e.title,t=e.colorBlockMap,o=e.fromSketch,i=e.handleDelColor,c=e.canDel,u=e.colorUnit,l=e.focusColor
...
_.propTypes={title:p.default.string.isRequired,colorBlockMap:p.default.array.isRequired,handleDelColor:p.default.func.isRequired,fromSketch:p.default.bool,canDel:p.default.bool,colorUnit:p.default.string,focusColor:p.default.string}
var k=(0,o.connect)(function(e){var t=e.container.previewSetting
return{userPickColor:t.userPickColor,focusColor:t.focusColor}})(_),T=function(e,t,n){return(0,y.getColorFromUnit)(e?(0,y.parseSketchColor2rgba)(t):t,n)},M=function(e){var t=e.color,n=e.rgbaColor,r=e.colorUnit,a=(e.index,e.handleDelColor),o=e.canDel,i=e.title,c=e.focusColor,u=t===(0,y.getColorFromUnit)(c,r)
...
,F(c,r,a)),k=u&&(0,D.default)({},U[a].opacity,F(u,r,a)),T=l&&(0,D.default)({},U[a].borderRadius,F(l,r,a)),M=f&&(0,D.default)({},U[a].backgroundColor,F(f,r,a,!0)),R=p&&(0,D.default)({},U[a].color,F(p,r,a,!0)),N=h&&(0,D.default)({},U[a].fontSize,F(h,r,a)),O=m&&(0,D.default)({},U[a].fontFamily,F(m,r,a)),I=v&&(0,D.default)({},U[a].fontStyle,F(v,r,a)),A=g&&(0,D.default)({},U[a].shadows,g),P=s&&(0,D.default)({},U[a].borderWidth,F(s,r,a)),j=d&&(0,D.default)({},U[a].borderColor,F(d,r,a,!0)),L=y&&(0,D.default)({},
U[a].textAlign,y)
return Object.assign({},S,E,C,x,_,k,T,P,j,M,R,N,I,L,A,O)}
...
default:return t+(0===l?"/*|*/":"")}case-2:t.split("/*|*/}").forEach(d)}}}}()},TKrE:function(e,t){e.exports=function(e){return e}},TOwV:function(e,t,n){"use strict"
...
var u=o.toolbarActiveItem,l=o.isFullScreenMode,s=u==M.PREVIEW,d=u==M.INSPECT,f=u==M.COMMENT,p=!O.isElectron()&&!O.isHTMLZip()&&d&&c&&B(),h=!a&&s&&(A.has(r)||i),m=R({"is-offline-mode":O.isHTMLZip(),"is-uichina":O.isUIChina()||O.isForum(),"full-screen":l})
...
return o||a?m.default.createElement(I,null):0===r.length?m.default.createElement(A,null):m.default.createElement("div",{className:_("slice-container")},r.map(function(e){var t=e.name,n=e.id,r=e.screen_cid,a=e.image,o=e.image_set
...
var N=function(){return m.default.createElement("div",{className:_("layer-load")},m.default.createElement("span",{className:_("spinner")}))},O=function(){return m.default.createElement("div",{className:_("download-slice-load")},m.default.createElement(N,null))},I=function(){return m.default.createElement("div",{className:_("slice-load-wrap")},m.default.createElement(N,null))},A=function(){return m.default.createElement("div",{className:_("no-slice")},m.default.createElement("img",{
...
Me=(0,je.transfromProptype)({attr:(0,Ie.default)({x:he,y:pe,width:me,height:ve,lineHeight:Ee,textAlign:B,opacity:Te,borderRadius:ge},ke),language:m,unit:n}),Re=ne?"ImageView":re?"TextView":"View",Ne="screen"===t.type||t.kind?t.name:O,Oe="line"===t.name
...
return 0==S?null:_.default.createElement("div",{ref:this.setCommentRef,className:E,onMouseEnter:this.toggleSelect,onMouseLeave:this.cancelSelect},_.default.createElement("div",null,_.default.createElement(M.ContentHeader,{markIndex:i,onSelect:this.handleSetting,onDelete:this.doDeleteThread,permission:o,information:y,ifShowBtn:!h,showByEnter:m}),_.default.createElement("div",{className:O("container-main")},g&&_.default.createElement(M.ContentMessage,{permission:o,comment:g,isFolded:p,isEdit:h,
toggleEdit:this.toggleEditing,getValue:this.getCommentMessage,setEditableSpanComponent:this.setEditableSpanComponent,onValueChange:this.doUpdateComment}),!this.state.isEdit&&_.default.createElement("div",{className:"".concat(O("container-bottom"))},g&&_.default.createElement("div",{className:N.default.time},T.default.L10N.parseTimeAgo(1e3*g.updated_at)),C&&_.default.createElement("div",{className:O("reply-sort"),onClick:this.toggleReply},_.default.createElement(k.default,{type:"dora",name:"reply",
...
default:return"px"}}},qT12:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
...
var u=!1
o.forEach(function(e){i&&e!==i?e.isIgnore=!0:c&&e!==c?e.isIgnore=!0:(e.isIgnore=u,u=!0)})}),T=function(){return{htmlString:b,cssString:w,domString:S,svgString:E,svgDataUrl:C,imageElement:x,canvasElement:_,pngDataUrl:k}},e.prev=46,e.t4=I.prepareHTMLString,e.next=50,(0,N.convertFragListWithUrlMap)(v)
...
n.d(t,"i",function(){return E}),n.d(t,"s",function(){return C}),n.d(t,"t",function(){return x}),n.d(t,"n",function(){return _}),n.d(t,"b",function(){return k}),n.d(t,"o",function(){return T}),n.d(t,"e",function(){return R}),n.d(t,"c",function(){return N}),n.d(t,"h",function(){return O}),n.d(t,"k",function(){return I}),n.d(t,"r",function(){return A}),n.d(t,"m",function(){return P}),n.d(t,"f",function(){return j}),n.d(t,"p",function(){return L}),n.d(t,"a",function(){return D}),n.d(t,"g",function(){return B}),
...
return S(l,M("apply",{context:e,fn:t},n))}function O(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return S(s,M("cps",e,n))}function I(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return S(d,M("fork",e,n))}function A(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return E(I.apply(void 0,[e].concat(n)))}function P(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
case"mradiobutton":return m.default.createElement(_,{widget:e})
case"mselect":return m.default.createElement(k,{widget:e})
case"button":return m.default.createElement(T,{widget:e})
case"hr":return m.default.createElement(M,{widget:e})
...
case"image_view":return m.default.createElement(L,{widget:e})
case"webpage":return m.default.createElement(P,{widget:e,isPreview:t})
case"video_view":return m.default.createElement(j,{widget:e})
...
case"android_keyboard":return m.default.createElement(U,{widget:e})
...
return m.default.createElement("input",{type:"checkbox",checked:e.checked})}}]),t}(y),x=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){return m.default.createElement("input",{type:"file"})}}]),t}(y),_=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",
...
return m.default.createElement("select",null,e.text.split(/\n/).map(function(e,t){return m.default.createElement("option",{key:e+t},e)}))}}]),t}(y),T=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return m.default.createElement("div",{className:"button-wrapper"},e.icon?(0,v.getIcon)(e):null,m.default.createElement("span",{className:"text"},e.text))}}]),t}(y),M=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=e.h()-10*e.s()/100
...
return m.default.createElement("svg",{xmlns:"http://www.w3.org/2000/svg"},m.default.createElement("path",{d:t}))}}]),t}(y),A=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){return m.default.createElement("span",null)}}]),t}(y),P=function(e){function o(){var e,t;(0,c.default)(this,o)
for(var n=arguments.length,r=new Array(n),a=0;a<n;a++)r[a]=arguments[a]
...
ut.r(ct),function(e,t){ut.d(ct,"css",function(){return F}),ut.d(ct,"keyframes",function(){return at}),ut.d(ct,"injectGlobal",function(){return ot}),ut.d(ct,"isStyledComponent",function(){return I}),ut.d(ct,"consolidateStreamedStyles",function(){return A}),ut.d(ct,"ThemeProvider",function(){return Re}),ut.d(ct,"withTheme",function(){return Be}),ut.d(ct,"ServerStyleSheet",function(){return pe}),ut.d(ct,"StyleSheetManager",function(){return fe}),ut.d(ct,"__DO_NOT_USE_OR_YOU_WILL_BE_HAUNTED_BY_SPOOKY_GHOSTS",
function(){return Fe})
var n=ut("+8Ar"),i=ut.n(n),d=ut("q1tI"),c=ut.n(d),r=ut("2q7i"),a=ut.n(r),o=ut("TAZq"),u=ut.n(o),l=ut("17x9"),s=ut.n(l),f=ut("2mql"),y=ut.n(f),p=ut("TOwV"),h="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},b=function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")},w=function(){function r(e,t){for(var n=0;n<t.length;n++){
var r=t[n]
...
T.use([N,R]),k.use([N,R])
var O=function(e,t,n){var r=e.join("").replace(g,"")
return T(n||!t?"":t,t&&n?n+" "+t+" { "+r+" }":r)}
function I(e){return"function"==typeof e&&"string"==typeof e.styledComponentId}function A(){0}var P=function(e){return String.fromCharCode(e+(25<e?39:97))},j=function(e){var t="",n=void 0
...
var Ne={},Oe=S({},Te,((Me={})[W]=s.a.oneOfType([s.a.instanceOf(de),s.a.instanceOf(pe)]),Me)),Ie={}
...
"var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"],Be=function(t){var e="function"==typeof t&&!(t.prototype&&"isReactComponent"in t.prototype),n=I(t)||e,r=function(o){function i(){var e,t
b(this,i)
for(var n=arguments.length,r=Array(n),a=0;a<n;a++)r[a]=arguments[a]
...
var Ue,qe,We,He,ze,Ve,Ye,Ze,Je,Xe,Ge,Ke,Qe,$e,et,tt=(Ue=j,qe=v,We=O,He=function(e){return Ue(Pe(e))},function(){function a(e,t,n){if(b(this,a),this.rules=e,this.isStatic=!Le&&function e(t,n){for(var r=0,a=t.length;r<a;r+=1){var o=t[r]
if(Array.isArray(o)&&!e(o))return!1
if("function"==typeof o&&!I(o))return!1}if(void 0!==n)for(var i in n)if("function"==typeof n[i])return!1
...
return e.withConfig=function(e){return t(n,r,S({},a,e))},e.attrs=function(e){return t(n,r,S({},a,{attrs:S({},a.attrs||B,e)}))},e}),rt=(Ve=tt,Ye=nt,function i(c,u,l){var e,t=u.isClass,n=void 0===t?!be(c):t,r=u.displayName,a=void 0===r?be(e=c)?"styled."+e:"Styled("+ye(e)+")":r,o=u.componentId,s=void 0===o?function(e,t,n){var r="string"!=typeof t?"sc":ge(t),a=(Ie[r]||0)+1
Ie[r]=a
...
return Ye(i,c,a)}}]),o}(f)
return g.attrs=h,g.componentStyle=v,g.contextTypes=Oe,g.displayName=a,g.styledComponentId=m,g.target=c,n&&y()(g,c,{attrs:!0,componentStyle:!0,displayName:!0,extend:!0,styledComponentId:!0,target:!0,warnTooManyClasses:!0,withComponent:!0}),g}),at=(Ze=j,Je=O,Xe=F,function(){var e=de.master,t=Xe.apply(void 0,arguments),n=Ze(Pe(JSON.stringify(t).replace(/\s|\\n/g,""))),r="sc-keyframes-"+n
return e.hasNameForId(r,n)||e.inject(r,Je(t,n,"@keyframes"),n),n}),ot=(Ge=O,Ke=F,function(){var e=de.master,t=Ke.apply(void 0,arguments),n="sc-global-"+Pe(JSON.stringify(t))
...
return t.defaultView||t.parentWindow||o}var I="ontouchstart"in o,A=R(o,"PointerEvent")!==m,P=I&&/mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),j="touch",L=25,D=1,B=4,F=8,U=1,q=2,W=4,H=8,z=16,V=q|W,Y=H|z,Z=V|Y,J=["x","y"],X=["clientX","clientY"]
...
var Re=1
function Ne(e){this.options=i({},this.defaults,e||{}),this.id=N++,this.manager=null,this.options.enable=w(this.options.enable,!0),this.state=Re,this.simultaneous={},this.requireFail=[]}function Oe(e){return 16&e?"cancel":8&e?"end":4&e?"move":2&e?"start":""}function Ie(e){return e==z?"down":e==H?"up":e==q?"left":e==W?"right":""}function Ae(e,t){var n=t.manager
...
this.options=i({},qe.defaults,t||{}),this.options.inputTarget=this.options.inputTarget||e,this.handlers={},this.session={},this.recognizers=[],this.oldCssProps={},this.element=e,this.input=new((n=this).options.inputClass||(A?fe:P?ge:I?be:ce))(n,K),this.touchAction=new Me(this,this.options.touchAction),He(this,!0),d(this.options.recognizers,function(e){var t=this.add(new e[0](e[1]))
...
//# sourceMappingURL=lib-preview-0d7a37552fccfcd5a19e.js.map